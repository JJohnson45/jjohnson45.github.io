...
*/
//function take an array and a value
...
_.filter = function(array, action){
   var newArray = [];
   //call action for each element in array
   //action takes arguments of the element, it’s index, and <array>
   for (var i = 0; i < array.length; i++){
      if (action(array[i], i, array)){
          //return new array for each value action passes true
...
_.partition = function(array, action){
   ...
   for (var i = 0; i < array.length; i++){
      if (action(array[i], i, array)){
          ...
          //return new array for each value action passes false
...
_.map = function(collection, action){
   var newArray = [];
       //if collection is an array
       //call action with arguments of each element, its index, and <collection>
       if (Array.isArray(collection)){
       for (var i = 0; i < collection.length; i++){
           //save the return value of each action call in a new array
...
*/
//takes an array, a function and a seed
